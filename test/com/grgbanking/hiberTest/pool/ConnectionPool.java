...
/*
 * 这个例子是根据POSTGRESQL数据库写的， 请用的时候根据实际的数据库调整。 调用方法如下： ① ConnectionPool connPool =
 ...
 * ,"Username" ,"Password"); ② connPool .createPool(); Connection conn =
 * connPool .getConnection(); connPool.returnConnection(conn);
 * connPool.refreshConnections(); connPool.closeConnectionPool();
 */
